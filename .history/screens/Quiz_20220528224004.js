...
const Quiz = () => {
  ...
  const renderNextButton = () => {
    if (showNextbutton) {
      return (
        <TouchableOpacity style={{display: 'flex', justifyContent: 'space-between', flexDirection: 'row', marginTop: 20, width: '30%', backgroundColor: COLORS.accent, padding: 20, borderRadius: 50}}>
