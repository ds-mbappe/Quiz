...
const Quiz = () => {
  ...
  const renderNextButton = () => {
    if (showNextbutton) {
      return (
        <TouchableOpacity style={{display: 'flex', justifyContent: 'center', flexDirection: 'row', marginTop: 20, width: '100%', backgroundColor: COLORS.accent, padding: 20, borderRadius: 50}}>
