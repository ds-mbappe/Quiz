...
const Quiz = () => {
  ...
  const renderNextButton = () => {
    if (showNextbutton) {
      return (
        <TouchableOpacity style={{display: 'flex', alignItems: 'flex-end', flexDirection: 'row', marginTop: 20, width: '30%', backgroundColor: COLORS.accent, padding: 20, borderRadius: 5}}>
